...
import "./indexProyect.css";

export default function IndexProyects() {
  return (
              ...
              <div className="col">
                <div className="card">
                  <div className="card-top">
                    <p className="card__title">proyect 1</p>
                  ...
                  <div className="card__btns">
                    ...
                    <button className="watch-btn">Abrir</button>
                  </div>
                </div>
              </div>
              <div className="col">
